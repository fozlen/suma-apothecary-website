          ...
          <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
              ...
              <div className="flex justify-center md:justify-start space-x-6">
                ...
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M9.16 12.165c0-1.374.81-2.295 1.92-2.295 1.11 0 1.92.921 1.92 2.295 0 1.374-.81 2.295-1.92 2.295-1.11 0-1.92-.921-1.92-2.295zm11.84-9.165v18c0 1.657-1.343 3-3 3h-12c-1.657 0-3-1.343-3-3v-18c0-1.657 1.343-3 3-3h12c1.657 0 3 1.343 3 3zm-6.5 9.165c0-2.484-1.8-4.295-4.42-4.295s-4.42 1.811-4.42 4.295c0 2.484 1.8 4.295 4.42 4.295s4.42-1.811 4.42-4.295zm4.5-2.165h-2v-2h2v2zm0 4h-2v-2h2v2z"/>
                  </svg>
                </a>
              </div>
            </div>
